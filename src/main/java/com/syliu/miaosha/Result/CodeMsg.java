package com.syliu.miaosha.Result;
...
public class CodeMsg {
    ...
    public static CodeMsg REQUEST_ILLEAGLE = new CodeMsg(500140, "请求非法：%s");
    ...
    public static CodeMsg OVER_VISIT = new CodeMsg(500503, "访问频率过高");
    private CodeMsg() {
    }
